    ...
    <div className="space-y-3">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-9 pr-3 py-2.5 rounded-xl border border-emerald-200 bg-white text-sm"
        />
      </div>
      ...
      <div className="flex flex-wrap gap-2">
        <button
          ...
          className="text-xs px-3 py-1.5 rounded-lg border border-emerald-200 text-emerald-800 hover:bg-emerald-50"
        >
          Marcar visíveis
        </button>
        <button
      ...
      <div className="max-h-72 overflow-y-auto rounded-2xl border border-emerald-100 bg-emerald-50 p-3 space-y-4">
        {groups.map(({ tier, items }) => (
          <div key={tier}>
            <p className="text-[11px] font-semibold uppercase tracking-wide text-emerald-800 mb-2 sticky top-0 bg-emerald-50 py-1">
              {TIER_LABEL[tier]}
            </p>
      ...
      {outroAtivo && (
        <div className="rounded-xl border border-emerald-300 bg-emerald-50 p-4 space-y-2">
          ...
          <input
            ...
            className="w-full rounded-lg border border-emerald-200 bg-white px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-400"
            autoFocus
          />
