    ...
    <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/50 p-4">
      ...
      >
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-2 text-sm text-gray-600 leading-relaxed">
              Atualizamos nossos documentos legais (v. {TERMS_VERSION} / {PRIVACY_POLICY_VERSION})
              em conformidade com a LGPD. Para continuar usando o MedSupAPP, leia e aceite as
              novas versões.
            </p>
          </div>
        </div>
        ...
        <p className="mt-4 text-sm text-gray-600">
          <Link href="/termos" target="_blank" className="font-medium text-emerald-600 hover:underline">
            Termos de Uso
          </Link>
          {' · '}
          <Link
        ...
        <button
          ...
          onClick={() => void accept()}
          disabled={submitting}
          className="mt-5 w-full rounded-xl bg-emerald-700 py-3 text-sm font-semibold text-white hover:bg-emerald-800 disabled:opacity-50 flex items-center justify-center gap-2"
        >
