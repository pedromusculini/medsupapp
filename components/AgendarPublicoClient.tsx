...
export default function AgendarPublicoClient({ slug }: { slug: string }) {
      ...
      <div className="min-h-screen bg-gradient-to-b from-emerald-50 to-white px-4 py-12">
        <div className="max-w-md mx-auto text-center">
          ...
          <p className="text-gray-600 mt-2">
            {info?.nome_exibicao} receberá sua reserva em breve.
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-emerald-50 to-[#f8f9fa]">
      ...
      <main className="max-w-lg mx-auto px-4 py-6 pb-24">
        ...
        {step !== 'telefone' && !pToken && (
          <button
            type="button"
            onClick={voltar}
            className="mb-4 flex items-center gap-1 text-sm text-emerald-600 font-medium"
          >
          ...
          {step === 'cadastro' && (
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full py-3.5 rounded-xl bg-emerald-700 text-white font-semibold text-sm disabled:opacity-50"
              >
                Continuar
              </button>
            </div>
                    ...
                    <button
                      ...
                      className={`py-2.5 rounded-xl text-sm font-medium border-2 ${
                        sel
                          ...
                          : 'border-gray-100 text-gray-800 hover:border-emerald-200'
                      }`}
                    >
                      {t}
                    </button>
          ...
          {step === 'confirmar' && slotSel && (
            <div className="space-y-4">
              ...
              <button
                ...
                onClick={confirmar}
                className="w-full py-3.5 rounded-xl bg-emerald-700 text-white font-semibold text-sm disabled:opacity-50 flex justify-center"
              >
