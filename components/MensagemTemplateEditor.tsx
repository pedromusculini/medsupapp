          ...
          {parts.map((part, index) =>
            part.type === 'token' ? (
              <div
                ...
                className="flex items-center gap-2 px-3 py-2 rounded-lg bg-emerald-700 text-white text-xs font-semibold"
              >
              ...
              <textarea
                ...
                className="block w-full rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm leading-relaxed resize-y min-h-[2.5rem] focus:ring-2 focus:ring-emerald-200 focus:border-emerald-600"
