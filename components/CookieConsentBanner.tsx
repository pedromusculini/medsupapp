...
export default function CookieConsentBanner() {
  ...
  return (
    <div
      ...
      className="fixed bottom-0 left-0 right-0 z-[100] p-4 pb-[max(1rem,env(safe-area-inset-bottom))] md:p-6 pointer-events-none safe-area-pb"
    >
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
          ...
          <div className="flex shrink-0 flex-col sm:flex-row gap-2 md:pt-0.5">
            ...
            <button
              type="button"
              onClick={accept}
              className="inline-flex items-center justify-center rounded-xl bg-emerald-700 px-5 py-2.5 text-sm font-semibold text-white hover:bg-emerald-800 transition"
            >
              Entendi e continuar
            </button>
          </div>
