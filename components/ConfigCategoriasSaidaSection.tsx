    ...
    <section className="mt-8 rounded-2xl border border-gray-100 bg-white p-5 shadow-sm">
            ...
            >
              ...
              {isEditing ? (
                <input
                  ...
                  className="min-w-0 flex-1 rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm text-gray-800 focus:border-emerald-600 focus:outline-none focus:ring-2 focus:ring-emerald-600/15"
                />
              ) : (
              ...
              <button
                ...
                className="inline-flex shrink-0 items-center gap-1 rounded-xl border border-emerald-200 px-3 py-2 text-xs font-semibold text-emerald-700 transition hover:bg-emerald-50"
              >
      ...
      <div className="mt-4 flex flex-wrap gap-3">
        <button
          ...
          className="inline-flex items-center gap-2 rounded-xl border border-emerald-200 px-4 py-2.5 text-sm font-semibold text-emerald-700 transition hover:bg-emerald-50 disabled:opacity-40"
        >
