          ...
          <div className="mb-6 flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-2 text-sm leading-relaxed text-slate-600">
                A agenda do MedSupAPP funciona com{' '}
                <strong>Google Calendar</strong> e exige pelo menos um{' '}
                <strong>médico cadastrado</strong> em Meu Perfil → Equipe.
                Sem Google conectado, o sistema não salva pacientes nem consultas.
              </p>
              {userEmail && (
          ...
          <ol className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="mt-1 text-sm text-slate-600">
                    {googleBlocked
                      ? google?.summary ||
                        'Conecte ou reconecte sua conta Google. Pacientes ficam no Drive; consultas no Calendar.'
                      : 'Google verificado e pronto para uso.'}
                  </p>
                  {googleBlocked && (
                    <a
                      href={googleAuthorizeUrl('/agenda')}
                      className="mt-3 inline-flex items-center gap-2 rounded-xl bg-emerald-600 px-4 py-2.5 text-sm font-semibold text-white hover:bg-emerald-700"
                    >
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0 flex-1">
                  <p className="font-semibold text-slate-900">
                    2. Pelo menos um médico na equipe
                    {!needsProfissional ? ' ✓' : ''}
                  </p>
                  <p className="mt-1 text-sm text-slate-600">
                    {needsProfissional
                      ? isClinica
                        ? 'Cadastre quem atende na clínica. O nome da clínica sozinho não habilita a agenda.'
                        : 'Cadastre o médico titular em Equipe para aparecer nos agendamentos.'
                      : `${profissionais.length} médico(s) cadastrado(s).`}
                  </p>
                  {needsProfissional && (
                    <Link
                      href="/dashboard/perfil"
                      className="mt-3 inline-flex items-center gap-2 rounded-xl border-2 border-emerald-600 bg-white px-4 py-2.5 text-sm font-semibold text-emerald-700 hover:bg-emerald-50"
                    >
