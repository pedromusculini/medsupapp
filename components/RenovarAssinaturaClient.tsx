...
export default function RenovarAssinaturaClient() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-emerald-50/80 to-gray-50 px-4 py-10">
      <div className="mx-auto max-w-md">
        <div className="mb-8 text-center">
          <p className="text-sm font-semibold uppercase tracking-wide text-emerald-800">MedSupAPP</p>
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            disabled={payLoading}
            className="flex w-full items-center justify-center gap-2 rounded-2xl bg-emerald-700 px-4 py-3.5 text-sm font-semibold text-white transition hover:bg-emerald-800 disabled:opacity-60"
          >
            {payLoading ? (
