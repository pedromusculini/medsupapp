...
const VERCEL_PROJECT = 'medsupapp';
...
const PRODUCTION_LINE_RE =
  /https:\/\/(medsupapp[a-z0-9-]*-pedro-henrique-musculini-s-projects\.vercel\.app)\s+●\s+(Ready|Queued|Building|Error|Canceled)\s+Production/;
