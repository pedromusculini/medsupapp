...
| 2 | Redirect apex → www | Acessar `https://medsupapp.com.br/...` | `middleware.ts` + `vercel.json` redirects |
...
| 9 | `middleware.ts` | Redirect host apex (`medsupapp.com.br` → www) |
...
6. Busca global: `MedSup`, `medsupapp`, `medsupapp.com.br` → substituir com revisão humana
...
| **Admin** | `INTERNAL_PRODUCT_ID=medsupapp` | `beauty-saas` (ex.) | `product-us` |
