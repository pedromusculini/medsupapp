...
Production URL: **https://www.medsupapp.com.br**
...
1. Vercel → **Domains** → `www.medsupapp.com.br` e `medsupapp.com.br`
...
Compare o hash da primeira linha **Ready** com o `source` de `www.medsupapp.com.br`.
