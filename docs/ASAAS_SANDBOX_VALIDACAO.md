...
Guia prático para homologar o modelo MedSupAPP **antes** de codar webhooks no app.
...
curl -X POST "https://api-sandbox.asaas.com/v3/subscriptions" \
  ...
  -d '{
    ...
    "description": "MedSupAPP - Médico Solo",
    "externalReference": "seu-email-de-teste@gmail.com"
  }'
```
...
"description": "MedSupAPP - teste webhook rápido"
```
...
No **sandbox**, crie (opcional) “produtos” ou use só `value` na API — o MedSup hoje usa:
