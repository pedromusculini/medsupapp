        ...
        {showSuccess ? (
          <div className="space-y-4 text-center">
            ...
            <p className="text-sm text-slate-600">
              {info.nomeClinica} agora pode ver e gerenciar sua agenda Google no MedSupAPP.
          ...
          <div className="space-y-4">
            <p className="text-sm text-amber-800">
              Este convite expirou. Peça à clínica um novo link pelo WhatsApp.
            </p>
          </div>
        ) : (
          <div className="space-y-5">
            <p className="text-sm text-slate-700">
              Olá, <strong>{info.nomeProfissional}</strong>! A clínica{' '}
              <strong>{info.nomeClinica}</strong> usa o MedSupAPP para organizar as consultas.
            </p>
            ...
            <div className="flex items-start gap-2 text-xs text-slate-500">
              ...
              <span>
                Você será redirecionado ao Google para autorizar. Pode revogar o acesso a qualquer
