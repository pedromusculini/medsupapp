...
export default function CalendarioAdicionarPage() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#f8f9fa] p-6">
        <div className="bg-white rounded-2xl border border-gray-100 p-8 text-center max-w-md">
          ...
          <Link href="/" className="mt-4 inline-block text-sm text-emerald-600 font-medium">
            Voltar ao site
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-emerald-50 to-[#f8f9fa] px-4 py-10">
      <div className="max-w-md mx-auto">
        <div className="text-center mb-6">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-emerald-200/40 mb-3">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 space-y-4">
          ...
          <div className="pt-2 space-y-3">
            <a
              ...
              className="flex items-center justify-center gap-2 w-full py-3.5 rounded-xl bg-emerald-700 hover:bg-emerald-800 text-white font-semibold text-sm transition-colors"
            >
            ...
            <a
              ...
              className="flex items-center justify-center gap-2 w-full py-3.5 rounded-xl border-2 border-emerald-600 text-emerald-600 font-semibold text-sm hover:bg-emerald-50 transition-colors"
            >
